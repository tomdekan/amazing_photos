			...
			{isOpen && imageUrl && (
				...
				>
					<motion.div
						...
						className="bg-slate-900/50 border border-slate-800 rounded-2xl shadow-2xl w-full max-w-7xl flex flex-col lg:flex-row overflow-hidden lg:h-[90vh]"
					>
						{/* Image Section */}
						<div className="w-full lg:w-2/3 h-96 lg:h-full relative">
							<Image
								src={imageUrl}
								alt="Enlarged view"
								fill
						...
						{/* Content Section */}
						<div className="w-full lg:w-1/3 p-8 flex flex-col justify-center items-center text-center">
							...
							<p className="text-slate-400 mb-6">
								Like what you see? Sign in to create your own amazing AI photos
								in seconds.
							</p>
