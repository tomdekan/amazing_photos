    ...
    <div className="mb-6 bg-slate-800/50 border border-slate-700 rounded-lg p-6 shadow-sm">
      ...
      <div className="mb-3">
        <div className="flex justify-between text-sm mb-1">
          ...
          <span className="font-medium text-white">{subscription.generationsUsed} / {subscription.generationsLimit}</span>
        </div>
      ...
      <div className="text-sm text-slate-400">
        <span className="font-medium text-white">{subscription.generationsRemaining}</span> generations remaining this month
      </div>
    </div>
  )
} 